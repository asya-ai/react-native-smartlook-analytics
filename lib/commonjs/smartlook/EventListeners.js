...
class EventListeners {
  constructor() {
    ...
    this.eventEmitter = new _reactNative.NativeEventEmitter(_reactNative.NativeModules.SmartlookEventEmitter);
  }
  ...
  async registerUserChangedListener(eventListenerCallback) {
    ...
    await _SmartlookModule.default.registerUserUrlChangedListener();
  }
  ...
  async removeUserChangedListener() {
    ...
    await _SmartlookModule.default.removeUserUrlChangedListener();
  }
  ...
  async registerSessionChangedListener(eventListenerCallback) {
    ...
    await _SmartlookModule.default.registerSessionUrlChangedListener();
  }
  ...
  async removeSessionChangedListener() {
    ...
    await _SmartlookModule.default.removeSessionUrlChangedListener();
  }
  ...
  async registerRecordingStatusChangedListener(eventListenerCallback) {
    ...
    await _SmartlookModule.default.registerRecordingStatusChangedListener();
  }
  ...
  async removeRecordingStatusChangedListener() {
    ...
    await _SmartlookModule.default.removeRecordingStatusChangedListener();
  }
  ...
  async registerRenderingModeChangedListener(eventListenerCallback) {
    ...
    await _SmartlookModule.default.registerRenderingModeChangedListener();
  }
  ...
  async removeRenderingModeChangedListener() {
    ...
    await _SmartlookModule.default.removeRenderingModeChangedListener();
  }
}
