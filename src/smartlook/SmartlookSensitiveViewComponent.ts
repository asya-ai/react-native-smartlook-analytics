 ...
 * ```
 */
const SmartlookSensitiveViewComponent = isFabricEnabled
  ? require('./specs/SmartlookSensitiveViewNativeComponent').default
  : requireNativeComponent('SmartlookSensitiveView');
